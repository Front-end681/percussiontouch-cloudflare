const CACHE_NAME = 'percussion-v1';
const ASSETS = ['./', './index.html', './manifest.json', './icon-192x192.png', './icon-512x512.png', './assets/index-BlvUSNo5.js', './assets/index-CDg9dXyS.css'];
